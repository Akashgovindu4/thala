function checkThala() {
    ...
    if (sum == 7) {
        ...
        Swal.fire({
            ...
            html: '<video autoplay muted loop class="text-center"><source src="https://memes.co.in/download/hd/Uploads/Media/Apr23/Wed26/898/98cbb274.mp4" type="video/mp4"></video>',
        ...
        Swal.fire({
            ...
            imageUrl: "https://images.hindustantimes.com/img/2022/08/01/1600x900/gambhir-laughing-getty_1659338575189_1659338582096_1659338582096.jpg",
            imageWidth: 400,
            imageHeight: 250,
            imageAlt: "Not Thala"
        });
